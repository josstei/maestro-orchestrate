...
const NPM_PACKAGE_EXCLUSION_ENTRIES: readonly InventoryEntry[] = [
  { path: '!dist/src/**/*.d.ts', scope: SCOPE.NPM },
  { path: '!dist/src/**/*.d.ts.map', scope: SCOPE.NPM },
  { path: '!dist/src/**/*.map', scope: SCOPE.NPM },
];

const PACKAGE_SURFACE_ENTRIES: readonly InventoryEntry[] = [
...
const RELEASE_ONLY_ENTRIES: readonly InventoryEntry[] = [
...
const INVENTORY = Object.freeze(
  [...RUNTIME_DIST_ENTRIES, ...NPM_PACKAGE_EXCLUSION_ENTRIES, ...PACKAGE_SURFACE_ENTRIES, ...RELEASE_ONLY_ENTRIES].map((entry) =>
    Object.freeze({ ...entry })
  )
);

function projectByScopes(scopes: readonly Scope[]): readonly string[] {
