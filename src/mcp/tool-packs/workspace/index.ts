 ...
 */
function registerWorkspacePack({ server, registry, onInitializeWorkspace, ...contextOptions }: any = {}) {
  defineTool({
    server,
    registry,
    ...
    handler: (args: any) => handleInitializeWorkspace(args),
  ...
  defineTool({
    ...
    handler: (args: any, ctx: any) => handleAssessTaskComplexity(args, ctx.projectRoot),
    ...contextOptions,
  });
  ...
  defineTool({
    ...
    handler: (args: any, ctx: any) => handleValidatePlan(args, ctx.projectRoot),
    ...contextOptions,
  });
  ...
  defineTool({
    ...
    handler: (args: any, ctx: any) => handleResolveSettings(args, ctx.projectRoot),
    ...contextOptions,
  });
}
