import { defineCommandTable, registerCommandTable, withRequiredProjectRoot } from '../command-table.js';
...
const memoryCommands = defineCommandTable(zodSchemas, {
  get_project_profile: {
    description:
    ...
    handler: withRequiredProjectRoot((args, projectRoot) => handleGetProjectProfile(args, projectRoot)),
  },
  update_project_profile: {
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleUpdateProjectProfile(args, projectRoot)),
  },
  record_validation_commands: {
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleRecordValidationCommands(args, projectRoot)),
  },
  get_agent_performance: {
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleGetAgentPerformance(args, projectRoot)),
  },
  recall_similar_sessions: {
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleRecallSimilarSessions(args, projectRoot)),
  },
  rate: {
    description:
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleRate(args, projectRoot)),
  },
  get_plan_accuracy: {
    description:
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleGetPlanAccuracy(args, projectRoot)),
  },
  query_architecture_memory: {
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleQueryArchitectureMemory(args, projectRoot)),
  },
  get_agent_memory: {
    description:
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleGetAgentMemory(args, projectRoot)),
  },
  append_agent_memory: {
    description:
      'Append one durable plain-text note to the target agent memory file under knowledge/agent-memory/<agent>.md.',
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleAppendAgentMemory(args, projectRoot)),
  },
  compact_archive: {
    description:
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleCompactArchive(args, projectRoot)),
  },
  record_knowledge: {
    description:
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleRecordKnowledge(args, projectRoot)),
  },
  query_knowledge: {
    description:
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleQueryKnowledge(args, projectRoot)),
  },
  export_memory_pack: {
    description:
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleExportMemoryPack(args, projectRoot)),
  },
  import_memory_pack: {
    description:
    ...
    requiresWorkspace: true,
    handler: withRequiredProjectRoot((args, projectRoot) => handleImportMemoryPack(args, projectRoot)),
  },
});

/**
 * Register the `memory` pack's 15 tools via the command-table helper, each
 ...
 */
function registerMemoryPack({ server, registry, ...contextOptions }: any = {}) {
  registerCommandTable(zodSchemas, memoryCommands, {
    server,
    registry,
    ...contextOptions,
  });
