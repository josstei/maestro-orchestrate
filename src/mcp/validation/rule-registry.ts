 ...
 * @returns {boolean}
 */
function cycleFreeGuard(_context: any, violations: any) {
  return !violations.some((violation: any) => violation.rule === 'cyclic_dependency');
}
...
const PLAN_VALIDATION_STAGES = Object.freeze([
  Object.freeze({
    ...
    haltOnError: true,
    rules: Object.freeze([
      Object.freeze({ id: 'plan_shape', evaluate: (c: any) => checkPlanShape(c.plan) }),
    ]),
  }),
  Object.freeze({
    id: 'phase-schema',
    haltOnError: true,
    rules: Object.freeze([
      Object.freeze({ id: 'phase_field_schema', evaluate: (c: any) => checkPhaseFieldSchema(c.phases) }),
    ]),
  }),
  Object.freeze({
    id: 'graph',
    haltOnError: false,
    rules: Object.freeze([
      Object.freeze({ id: 'phase_count', evaluate: (c: any) => checkPhaseCount(c.phases, c.taskComplexity) }),
      Object.freeze({ id: 'duplicate_id', evaluate: (c: any) => checkDuplicateIds(c.phases) }),
      Object.freeze({ id: 'dangling_dependency', evaluate: (c: any) => checkDanglingDependencies(c.phases) }),
      Object.freeze({ id: 'unknown_agent', evaluate: (c: any) => checkUnknownAgents(c.phases) }),
      Object.freeze({ id: 'agent_capability', evaluate: (c: any) => checkAgentCapabilities(c.phases) }),
      Object.freeze({ id: 'cyclic_dependency', evaluate: (c: any) => checkCycles(c.phases, c.phaseById) }),
    ]),
  }),
  Object.freeze({
    id: 'dependency-depth',
    ...
    buildsProfile: true,
    rules: Object.freeze([
      Object.freeze({ id: 'file_overlap', evaluate: (c: any) => checkFileOverlap(c.phases, c.depths) }),
      Object.freeze({ id: 'redundant_dependency', evaluate: (c: any) => checkRedundantDependencies(c.phases, c.phaseById) }),
    ]),
  }),
]);
