...
class MemoryStore {
   ...
   */
  constructor(projectRoot: any, { clock = createSystemClock() }: any = {}) {
   ...
   * @returns {MemoryStore}
   */
  static forProjectRoot(projectRoot: any, options?: any) {
   ...
   * @returns {{ schema_version: number, interfaces: object[], patterns: object[], integration_points: object[], assumptions: object[], warnings: object[] }}
   */
  writeArchitectureMemory(graph: any) {
   ...
   * @returns {{ schema_version: number, records: Array<object> }}
   */
  appendAgentPerformance(records: any) {
