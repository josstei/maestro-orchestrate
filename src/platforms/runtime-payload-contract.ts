...
const PLANNED_TOPOLOGY_DECISION = Object.freeze({
  ...
  runtimeFormat: 'NodeNext ESM JavaScript emitted under dist/src/',
  note:
    'Approved Option 1 target: TypeScript source remains human-authored while public bins, MCP wrappers, and package/release artifacts execute compiled dist/src output.',
});
