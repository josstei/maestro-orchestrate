...
function getVersionEntries(root) {
    ...
    const claudeMarketplacePlugin = findNamedPlugin(claudeMarketplace, 'maestro', '.claude-plugin/marketplace.json');
    return [
...
function assertRuntimeManifestShape(root, expectedVersion = null) {
    ...
    const codexMarketplacePlugin = findNamedPlugin(codexMarketplace, 'maestro', '.agents/plugins/marketplace.json');
