 ...
 */
function runPlanValidation(plan, taskComplexity, stages = PLAN_VALIDATION_STAGES) {
    ...
    for (const stage of stages) {
        ...
        if (stage.haltOnError && stageViolations.some((violation) => violation.severity === 'error')) {
