...
function registerContentPack({ server, registry, ...contextOptions } = {}) {
    defineTool({
        ...
        description: 'Read one or more Maestro skills, protocols, templates, or references from the runtime-configured Maestro content source and apply runtime-specific transforms before returning them.',
    ...
    defineTool({
        ...
        registry,
        name: 'get_agent',
        description: 'Read one or more Maestro agent methodology definitions. Returns the methodology body, declared tool restrictions, and a runtime-specific tool_name for dispatch.',
    ...
    defineTool({
        ...
        description: 'Returns tool mappings, agent dispatch syntax, MCP prefixes, and path variables for the current Maestro runtime. Call once at session start (step 0) and carry the returned context through the session.',
