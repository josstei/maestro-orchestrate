...
export const zodSchemas = {
    create_session: {
        ...
        implementation_plan_content: z
            .string()
            .describe('Inline implementation-plan Markdown. Requires implementation_plan_filename; mutually exclusive with implementation_plan.')
            .optional(),
        implementation_plan_filename: z
            .string()
            .describe("Basename-only filename (no separators, no '..') used when materializing implementation_plan_content into <state_dir>/plans/.")
            .optional(),
    ...
    transition_phase: {
        ...
        task_report: z
            .string()
            .describe('Full agent Task Report text for the completed phase. The server derives blocker_count by parsing its Blockers section.')
            .optional(),
        review_finding_count: z
            .number()
            .nullable()
            .describe('Number of Completion-phase code-review findings recorded for the completed phase. Stored as review_finding_count.')
            .optional(),
    },
    archive_session: {
        session_id: z.string(),
    ...
    record_design_approval: {
        ...
        design_document_path: z
            .string()
            .describe('Absolute or workspace-relative path to the approved design document. Mutually exclusive with design_document_content.')
            .optional(),
        design_document_content: z
            .string()
            .describe('Inline design-document Markdown. Requires design_document_filename; mutually exclusive with design_document_path.')
            .optional(),
        design_document_filename: z
            .string()
            .describe("Basename-only filename (no separators, no '..') used when materializing design_document_content into <state_dir>/plans/.")
            .optional(),
    },
