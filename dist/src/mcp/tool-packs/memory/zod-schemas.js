...
export const zodSchemas = {
    ...
    query_architecture_memory: {
        query: z
            .string()
            .describe('Optional case-insensitive substring to match against architecture-memory entry values.')
            .optional(),
    },
    get_agent_memory: {
    ...
    import_memory_pack: {
        path: z
            .string()
            .describe('Optional path to a memory pack under the resolved Maestro state directory. Defaults to memory-pack.json.')
            .optional(),
    },
};
