 ...
 */
function recordPlanAccuracy(state, projectRoot) {
    ...
    const record = {
        ...
        precision: actualFileCount > 0 ? matchedFileCount / actualFileCount : 0,
        recall: plannedFileCount > 0 ? matchedFileCount / plannedFileCount : 0,
 ...
 */
function handleGetPlanAccuracy(_params, projectRoot) {
    const records = new MemoryStore(projectRoot).readPlanAccuracy();
