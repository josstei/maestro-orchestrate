...
A bundled Model Context Protocol server providing 25 tools across 4 packs:
...
- **Memory** (5): get_project_profile, update_project_profile, record_validation_commands, get_agent_performance, recall_similar_sessions
