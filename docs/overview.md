...
A bundled Model Context Protocol server providing 23 tools across 4 packs:
...
- **Memory** (3): get_project_profile, update_project_profile, record_validation_commands
