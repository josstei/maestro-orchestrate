...
A bundled Model Context Protocol server providing 24 tools across 4 packs:
...
- **Memory** (4): get_project_profile, update_project_profile, record_validation_commands, get_agent_performance
