...
A bundled Model Context Protocol server providing 37 tools across 5 packs:
...
- **Memory** (11): get_project_profile, update_project_profile, record_validation_commands, get_agent_performance, recall_similar_sessions, rate_phase, rate_session, get_plan_accuracy, query_architecture_memory, get_agent_memory, append_agent_memory
